 ...
 * import time, before the DI container and therefore before the env schema. Mirrors the int
 * 1..50 rule of the env schema (default 10) and throws there — the old `Number(x ?? 10)` gave
 * NaN, i.e. no limit at all.
 */
